...
# my $t = Test::Nginx->new()->has(qw/http rewrite proxy/)->plan(44);
...
# like(get('/', 'User-Agent: Galaxy'),
#     qr/600 Connection History Is Maintained/, 'User-Agent: Galaxy');
like(get('/', 'User-Agent: Safari/Mac OS X'),
    qr/204/, 'User-Agent: Safari/Mac OS X');
